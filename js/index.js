...
let fruitsJSON = `[
  ...
  {"kind": "авокадо", "color": "зеленый", "weight": 18},
  {"kind": "банан", "color": "желтый", "weight": 90},
  {"kind": "кумкват", "color": "оранжевый", "weight": 6},
  {"kind": "помелод", "color": "желто-зеленый", "weight": 1},
  {"kind": "папайя", "color": "оранжево-желтый", "weight": 4},
  {"kind": "лонган", "color": "светло-бежевый", "weight": 10}
]`;
...
const comparationColor = (a, b) => {
  ...
  const priority = ['зеленый', 'желтый', 'фиолетовый', 'розово-красный', 'светло-коричневый', 'оранжевый', 'желто-зеленый', 'светло-бежевый'];
